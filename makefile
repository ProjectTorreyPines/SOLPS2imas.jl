...
env_with_cloned_repo r:
	...
	julia --project=. -e 'using Pkg; Pkg.rm(["IMASDD", "GGDUtils", "Fortran90Namelists"]); Pkg.develop(path="../IMASDD"); Pkg.develop(path="../GGDUtils"); Pkg.develop(path="../Fortran90Namelists"); Pkg.instantiate()'
